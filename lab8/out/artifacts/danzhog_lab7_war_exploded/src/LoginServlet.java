...
public class LoginServlet extends ChatServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (name==null) {
            ...
            for (Cookie aCookie: request.getCookies())
            {
                ...
                {
                    // Запомнить значение этого cookie – это старый идентификатор сессии
    ...
    {
        // Задать кодировку HTTP-запроса
        // Иначе вместо символов будет каша
